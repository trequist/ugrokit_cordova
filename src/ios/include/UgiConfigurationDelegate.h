 ...
 */
- (void) chooseRegionFromRegions:(NSArray *)regionNames
...
/**
 Confirm the region about to be set
 
 @param regionName          The region
 @param completion          Block to execute, with YES if confirmed
 */
- (void)confirmRegion:(NSString *)regionName
       withCompletion:(void(^)(BOOL confirmed))completion;
